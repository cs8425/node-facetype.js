...
var in_file = process.argv[2] || 'WenQuanYiMicroHei.ttf';
var out_file = process.argv[3] || path.parse(in_file).base + '_font.typeface.js';

console.log('in', in_file);
console.log('out', out_file);

var raw = fs.readFileSync(in_file);
// var buffer = new ArrayBuffer(raw);
var font = opentype.parse(raw);
